...
const defaultMeta = {
  ...
  url: 'https://www.macengsociety.ca',
  type: 'website',
  robots: 'follow, index',
  /**
...
export default function Seo(props: SeoProps) {
  ...
  return (
    <Head>
      ...
      <meta name='twitter:site' content='@macengsociety' />
      ...
      {meta.date && (
        <>
          ...
          <meta
            ...
            content='Willie Pai, Baoze Lin, Hady Ibrahim, Jeremy Langner, Kyle Hagerman, Tushar Aggarwal'
          />
        </>
      )}
